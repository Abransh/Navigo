...
const Navbar: React.FC = () => {
  ...
  return (
    <>
      {/* Mobile Menu Wrapper - Shows when menu is open */}
      <div className={`mobile-menu-wrapper ${mobileMenuOpen ? '' : 'hidden'}`}>
        <div className="mobile-menu_list-wrapper">
          ...
          <Link href="#team" className="mobile-menu_text" onClick={toggleMenu}>Team</Link>
          <Link href="#faq" className="mobile-menu_text" onClick={toggleMenu}>FAQ</Link>
          ...
          <Link href="#" className="mobile-nav-button w-inline-block"></Link>
        </div>
      </div>

      {/* Main Navbar */}
      <div data-collapse="medium" data-animation="default" data-duration="400" data-w-id="ef8790b4-0a72-76e1-9a3c-3051b2aedb38" data-easing="ease" data-easing2="ease" role="banner" className="navbar_component w-nav">
            ...
            <div className="navbar_menu-link-wrapper">
              <div className="menu-link-item-wrapper">
                ...
                <img
                  ...
                  loading="lazy"
                  id="w-node-_34c3ec77-8c03-59ad-cdbc-327d20b388e9-3b306ed1"
                  alt=""
                  className="squiggle"
                />
              </div>
              <div className="menu-link-item-wrapper">
                ...
                <img
                  src="/images/squiggle.svg"
                  loading="lazy"
                  id="w-node-f40bc2e7-3ae4-3966-f550-e274b677aaf5-3b306ed1"
                  alt=""
                  className="squiggle"
                />
              </div>
              <div className="menu-link-item-wrapper">
                ...
                <img
                  src="/images/squiggle.svg"
                  loading="lazy"
                  id="w-node-_6b88645a-fd60-dc02-46ee-266d110fb970-3b306ed1"
                  alt=""
                  className="squiggle"
                />
              </div>
              <div className="menu-link-item-wrapper">
                ...
                <img
                  src="/images/squiggle.svg"
                  loading="lazy"
                  id="w-node-_6295b08f-223c-4dfa-435d-3327f4e9cbdb-3b306ed1"
                  alt=""
                  className="squiggle"
                />
              </div>
          ...
          <div id="w-node-ef8790b4-0a72-76e1-9a3c-3051b2aedb74-3b306ed1" className="navbar_button-wrapper">
            ...
            <div className="mobile-menu_button-wrapper">
              <div 
                ...
                data-w-id="0acae8fb-97af-269e-22c7-eebad7406188"
              ...
              >
                <div 
                  ...
                  data-w-id="0acae8fb-97af-269e-22c7-eebad7406189"
